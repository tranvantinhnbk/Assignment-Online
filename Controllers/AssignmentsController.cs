...
namespace Assignment_Online.Controllers
{
    ...
    public class AssignmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Question,Answer")] Assignment assignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Question,Answer")] Assignment assignment)
        {
            if (id != assignment.Id)
            {
                return NotFound();
